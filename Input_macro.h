...
CMD6236K[] = { INPUT6, INPUT2, INPUT3, INPUT_NOT3 | INPUT6, INPUT_K, INPUT_END | 20 },
CMD236P[] = { INPUT2, INPUT3, INPUT_NOT3 | INPUT6, INPUT_P, INPUT_END | 18 },
...
CMD2K[] = { INPUT_NOT_K, INPUT2 | INPUT_K, INPUT_END | 10 },	//しゃがみキック入力
CMD5K[] = { INPUT_NOT_K, INPUT_K, INPUT_END | 10 },	//立ちキック入力
CMD2P[] = { INPUT2 | INPUT_P, INPUT_END | 10 },	//しゃがみパンチ入力
CMD5P[] = { INPUT_NOT_P, INPUT_P, INPUT_END | 10 },	//立ちパンチ入力
